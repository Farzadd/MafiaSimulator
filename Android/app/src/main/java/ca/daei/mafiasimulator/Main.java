...
public class Main extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MafiaCore.GAMESTATE = MafiaCore.GameStates.GAME_READY;
    }
    ...
    public void onBackPressed() {
        ...
        if (drawer.isDrawerOpen(GravityCompat.START)) {
            ...
            new AlertDialog.Builder(this)
                    .setTitle("Qutting Game")
                    .setMessage("Are you sure you wish to quit the current game before its over?")
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        TextView playerName = (TextView) findViewById(R.id.mainPlayerName);
        TextView role = (TextView) findViewById(R.id.mainRole);
        TextView status = (TextView) findViewById(R.id.mainStatus);
        playerName.setText(MafiaCore.USERID);
        role.setText(MafiaCore.USERROLE);
        status.setText(MafiaCore.USERALIVE ? "ALIVE" : "DEAD");
